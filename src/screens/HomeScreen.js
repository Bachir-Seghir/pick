            ...
            <ScrollView bounces={false}>
                ...
                <View style={styles.view5}>
                    <View style={styles.view6}>
                        ...
                        <View>
                            <Text style={{ fontSize: 18, color: colors.black }}>Log 200, Hay Yasmine 2</Text>
                            <Text style={{ color: colors.grey3 }}>Oran 31000, Algeria</Text>
                ...
                <View style={{
                    ...
                    >
                        {carsAround.map((car, index) =>
                            <MapView.Marker
                                coordinate={car} key={index.toString()}
                            >
